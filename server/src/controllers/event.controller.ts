...
export class EventController {
    ...
    static async getById(req: Request, res: Response, next: NextFunction) {
        try {
            const event = await EventService.findById(req.params.id, req.branchScope);
    ...
    static async addMenuItems(req: Request, res: Response, next: NextFunction) {
        try {
            const event = await EventService.addMenuItems(req.params.id, req.body.items);
            res.json({ success: true, data: event });
        } catch (error) { next(error); }
    }
    ...
    static async finalizeMenu(req: Request, res: Response, next: NextFunction) {
        try {
            ...
            const menuItems = event.menuSelections.map((ms) => ({
    ...
    static async addVendor(req: Request, res: Response, next: NextFunction) {
        try {
            const event = await EventService.addVendor(req.params.id, req.body);
            res.json({ success: true, data: event });
        } catch (error) { next(error); }
    }
    ...
    static async addChecklistItem(req: Request, res: Response, next: NextFunction) {
        try {
            const event = await EventService.addChecklistItem(req.params.id, req.body);
            res.json({ success: true, data: event });
        } catch (error) { next(error); }
    }
    ...
    static async updateChecklistItem(req: Request, res: Response, next: NextFunction) {
        try {
            const item = await EventService.updateChecklistItem(req.params.checklistId, req.body.status);
